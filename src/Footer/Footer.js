  ...
  return (
    <div className="nth9" id="footerAnchor">
          ...
          <div className="nth9right">
            <div className="nth9RightP">
              ...
              <p className="nth9RightP2">
                <span>
                  Mail:{" "}
                  <a href="https://localhost:3000" rel="noreferrer">
                    info@mysite.com
                  </a>
                </span>
            ...
            <div className="nth9A">
              ...
              <a
                href="https://www.instagram.com/wix/?__coig_restricted=1"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <p className="nth9LeftP2">
          © 2035 by Plantlife Landscaping. Powered and secured by <a
            href="https://tr.wix.com/?utm_campaign=vir_created_with"
            target="_blank"
            rel="noreferrer"
          >Wix</a>
        </p>
